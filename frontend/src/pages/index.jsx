...
const Index = () => {
    ...
    return (
        <div className="bg-[#18191b] min-h-screen w-full">
                ...
                <div className={`w-screen ${show ? 'visible opacity-1000' : 'invisible'} transition-all duration-500 h-screen fixed bg-[#252627ad] flex justify-center items-center `}>
                        <div className="w-[350px] bg-[#323335] m-auto px-6 py-4 rounded-md relative">
                            ...
                            <form>
                                <div className="flex flex-col gap-3 mb-3 text-white">
                                    ...
                                    <input onChange={inputHandle} type="email" name="email" id="email" className="px-3 py-2 rounded-md border outline-none border-[#5c5c5e] focus:border-purple-500 bg-transparent" placeholder="email" value={state.email}/>
                                </div>
                                <div className="flex flex-col gap-3 mb-3 text-white">
                                    <label htmlFor="email">Password</label>
                                    <input onChange={inputHandle} type="password" name="password" id="password" className="px-3 py-2 rounded-md border outline-none border-[#5c5c5e] focus:border-purple-500 bg-transparent" placeholder="password" value={state.password}/>
                                </div>
                                <div>
                                    <button className="px-3 py-2 rounded-md bg-purple-500 w-full outline-none hover:bg-purple-600 text-white">SignIn</button>
                                </div>

                                <div className="flex py-4 justify-between items-center px-3">
                                    <div className="w-[45%] h-[1px] bg-slate-500">
                                    </div>
                            ...
                            }
                            {
                                ...
                                <div className="flex flex-col gap-3 mb-3 text-white">
                                    ...
                                    <input onChange={inputHandle} type="text" name="name" id="name" className="px-3 py-2 rounded-md border outline-none border-[#5c5c5e] focus:border-purple-500 bg-transparent" placeholder="name" value={state.name}/>
                                </div>
                                <div className="flex flex-col gap-3 mb-3 text-white">
                                    <label htmlFor="email">Email</label>
                                    <input onChange={inputHandle} type="email" name="email" id="email" className="px-3 py-2 rounded-md border outline-none border-[#5c5c5e] focus:border-purple-500 bg-transparent" placeholder="email" value={state.email}/>
